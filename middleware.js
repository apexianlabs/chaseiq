...
export function middleware(request) {
  ...
  if (hostname === 'chaseiq.app' || hostname === 'www.chaseiq.app') {
    if (pathname.startsWith('/dashboard') || pathname.startsWith('/billing') ||
        pathname.startsWith('/generate') || pathname.startsWith('/login') ||
        pathname.startsWith('/signup')) {
      return NextResponse.redirect(new URL('https://app.chaseiq.app' + pathname, request.url))
    }
  }
